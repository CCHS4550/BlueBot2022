...
public interface RobotMap {
    ...
    public static final int FRONT_LEFT_PORT = 3; //front and back dont matter. Just the fact these two are on this side
    ...
    // Shooter
    public static final int FLYWHEEL_ONE_PORT = 6;
